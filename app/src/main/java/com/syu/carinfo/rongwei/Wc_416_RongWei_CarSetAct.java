    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_plus11 /* 2131427523 */:
                ...
                setCarInfo(98, value27);
                break;
            case R.id.btn_minus12 /* 2131427525 */:
                int value28 = DataCanbus.DATA[132] - 1;
                if (value28 < 0) {
                    value28 = 2;
                }
                setCarInfo(100, value28);
                break;
            case R.id.btn_plus12 /* 2131427527 */:
                int value29 = DataCanbus.DATA[132] + 1;
                if (value29 > 2) {
                    value29 = 0;
                }
                setCarInfo(100, value29);
                break;
            ...
            case R.id.ctv_checkedtext10 /* 2131427542 */:
                ...
                setCarInfo(66, value38);
                break;
            case R.id.ctv_checkedtext11 /* 2131427543 */:
                int value39 = DataCanbus.DATA[111];
                if (value39 == 1) {
                    value39 = 0;
                } else if (value39 == 0) {
                    value39 = 1;
                }
                setCarInfo(35, value39);
                break;
            case R.id.ctv_checkedtext12 /* 2131427544 */:
                int value40 = DataCanbus.DATA[112];
                if (value40 == 1) {
                    value40 = 0;
                } else if (value40 == 0) {
                    value40 = 1;
                }
                setCarInfo(36, value40);
                break;
            case R.id.ctv_checkedtext13 /* 2131427545 */:
                int value41 = DataCanbus.DATA[113];
                if (value41 == 1) {
                    value41 = 0;
                } else if (value41 == 0) {
                    value41 = 1;
                }
                setCarInfo(37, value41);
                break;
            case R.id.ctv_checkedtext14 /* 2131427546 */:
                int value42 = DataCanbus.DATA[114];
                if (value42 == 1) {
                    value42 = 0;
                } else if (value42 == 0) {
                    value42 = 1;
                }
                setCarInfo(37, value42);
                break;
            case R.id.ctv_checkedtext15 /* 2131427547 */:
                int value43 = DataCanbus.DATA[115];
                if (value43 == 1) {
                    value43 = 0;
                } else if (value43 == 0) {
                    value43 = 1;
                }
                setCarInfo(38, value43);
                break;
            case R.id.ctv_checkedtext16 /* 2131427548 */:
                int value44 = DataCanbus.DATA[116];
                if (value44 == 1) {
                    value44 = 0;
                } else if (value44 == 0) {
                    value44 = 1;
                }
                setCarInfo(39, value44);
                break;
            case R.id.ctv_checkedtext17 /* 2131427647 */:
                int value45 = DataCanbus.DATA[119];
                if (value45 == 1) {
                    value45 = 0;
                } else if (value45 == 0) {
                    value45 = 1;
                }
                setCarInfo(70, value45);
                break;
            case R.id.ctv_checkedtext18 /* 2131427649 */:
                int value46 = DataCanbus.DATA[120];
                if (value46 == 1) {
                    value46 = 0;
                } else if (value46 == 0) {
                    value46 = 1;
                }
                setCarInfo(4, value46);
                break;
            ...
            case R.id.ctv_checkedtext24 /* 2131427832 */:
                ...
                setCarInfo(103, value52);
                break;
            case R.id.ctv_checkedtext25 /* 2131427834 */:
                int value53 = DataCanbus.DATA[139];
                if (value53 == 1) {
                    value53 = 0;
                } else if (value53 == 0) {
                    value53 = 1;
                }
                setCarInfo(107, value53);
                break;
            case R.id.ctv_checkedtext26 /* 2131427836 */:
                int value54 = DataCanbus.DATA[140];
                if (value54 == 1) {
                    value54 = 0;
                } else if (value54 == 0) {
                    value54 = 1;
                }
                setCarInfo(106, value54);
                break;
            ...
            case R.id.ctv_checkedtext31 /* 2131427887 */:
                ...
                setCarInfo(114, value60);
                break;
            case R.id.btn_minus16 /* 2131427888 */:
                int value61 = DataCanbus.DATA[137] - 1;
                if (value61 < 0) {
                    value61 = 2;
                }
                setCarInfo(109, value61);
                break;
            case R.id.btn_plus16 /* 2131427889 */:
                int value62 = DataCanbus.DATA[137] + 1;
                if (value62 > 2) {
                    value62 = 0;
                }
                setCarInfo(109, value62);
                break;
            case R.id.btn_minus17 /* 2131427890 */:
                int value63 = DataCanbus.DATA[146];
                if (value63 > 30) {
                    value63 -= 5;
                }
                if (value63 < 30) {
                ...
                setCarInfo(115, value63);
                break;
            case R.id.btn_plus17 /* 2131427891 */:
                int value64 = DataCanbus.DATA[146];
                if (value64 < 240) {
                    value64 += 5;
                }
                if (value64 > 240) {
                ...
                setCarInfo(115, value64);
                break;
            case R.id.ctv_checkedtext28 /* 2131427892 */:
                int value65 = DataCanbus.DATA[142];
                if (value65 == 1) {
                    value65 = 0;
                } else if (value65 == 0) {
                    value65 = 1;
            ...
            case R.id.btn_minus20 /* 2131427893 */:
                int value66 = DataCanbus.DATA[149];
                if (value66 > 51) {
                    value66--;
                }
            ...
            case R.id.btn_plus20 /* 2131427894 */:
                int value67 = DataCanbus.DATA[149];
                if (value67 < 127) {
                    value67++;
                }
