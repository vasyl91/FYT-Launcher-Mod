...
public class JiaNianHuaCarSettings extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CheckedTextView) findViewById(R.id.jia_btn_environment_light_switch)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View arg0) {
                ...
                if (JiaNianHuaCarSettings.this.mLight == 0) {
                    ...
                    JiaNianHuaCarSettings.this.editor.apply();
        ...
        ((Button) findViewById(R.id.jnh_unit_set_plus)).setOnClickListener(new View.OnClickListener() { 
            @Override
        ...
        ((Button) findViewById(R.id.jnh_unit_set_minus)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View v) {
                JiaNianHuaCarSettings.this.mUnit = JiaNianHuaCarSettings.this.sp.getInt("unit", 0);
        ...
        ((CheckedTextView) findViewById(R.id.jia_btn_information_point_state)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View arg0) {
        ...
        ((CheckedTextView) findViewById(R.id.jia_btn_warning_point_state)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View arg0) {
        ...
        ((Button) findViewById(R.id.jnh_turnlight_set_plus)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View v) {
        ...
        ((Button) findViewById(R.id.jnh_turnlight_set_minus)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View v) {
                JiaNianHuaCarSettings.this.mTurnLightState = JiaNianHuaCarSettings.this.sp.getInt("turnlight", 0);
        ...
        ((CheckedTextView) findViewById(R.id.jia_btn_dvd_state)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View arg0) {
        ...
        ((CheckedTextView) findViewById(R.id.jia_btn_navi_root_state)).setOnClickListener(new View.OnClickListener() { 
            @Override
            public void onClick(View arg0) {
