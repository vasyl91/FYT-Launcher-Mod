...
public class DjDodgeFrontAirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.dj.dodge.DjDodgeFrontAirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 8:
                    DjDodgeFrontAirControlAct.this.mUpdaterAirWindLevelLeft();
                    DjDodgeFrontAirControlAct.this.mUpdatePowerOn();
                    break;
                case 9:
                    DjDodgeFrontAirControlAct.this.mUpdateRearDefrost();
                    break;
                case 10:
                    DjDodgeFrontAirControlAct.this.mUpdateCycle();
                    break;
                case 11:
                    DjDodgeFrontAirControlAct.this.mUpdateAcOn();
                    break;
                case 12:
                case 13:
                case 14:
                    DjDodgeFrontAirControlAct.this.updateBtnSource();
                    break;
                case 15:
                    DjDodgeFrontAirControlAct.this.mUpdateDualOn();
                    break;
                case 16:
                    DjDodgeFrontAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 17:
                    DjDodgeFrontAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 18:
                    DjDodgeFrontAirControlAct.this.mUpdaterSeatHeatLeft();
                    break;
                case 19:
                    DjDodgeFrontAirControlAct.this.mUpdaterSeatHeatRight();
                    break;
                case 20:
                    DjDodgeFrontAirControlAct.this.mUpdateAutoOn();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0452_dj_dodge_jcuv_air_control);
        init();
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_rearpage /* 2131427448 */:
                flag = true;
                try {
                    startActivity(new Intent(this, (Class<?>) DjDodgeRearAirControlAct.class));
                    break;
                } catch (Exception e) {
                    e.printStackTrace();
                    break;
    ...
    public void mUpdateAirTempLeft() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_left)) != null) {
            ...
            if (temp == -3) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_left)).setText(((temp + 13) * 1.0f) + "℃");
            } else {
    ...
    public void mUpdateAirTempRight() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_right)) != null) {
            ...
            if (temp == -3) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_right)).setText(((temp + 13) * 1.0f) + "℃");
            } else {
