...
public class DjDodgeRearAirControlAct extends Activity implements View.OnTouchListener {
    ...
    private final IUiNotify mNotifyCanbus = new IUiNotify() { 
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 21:
                    DjDodgeRearAirControlAct.this.mUpdatePowerOn();
                    break;
                case 22:
                case 23:
                    DjDodgeRearAirControlAct.this.updateBtnSource();
                    break;
                case 25:
                    DjDodgeRearAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 26:
                    DjDodgeRearAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 27:
                    DjDodgeRearAirControlAct.this.mUpdateRearLockOn();
                    break;
            }
        }
    };
