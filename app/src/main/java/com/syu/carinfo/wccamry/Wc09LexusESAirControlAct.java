...
public class Wc09LexusESAirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.wccamry.Wc09LexusESAirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 41:
                    Wc09LexusESAirControlAct.this.mUpdateAutoOn();
                    break;
                case 42:
                    Wc09LexusESAirControlAct.this.mUpdateAcOn();
                    break;
                case 43:
                    Wc09LexusESAirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 44:
                    Wc09LexusESAirControlAct.this.mUpdateRearDefrost();
                    break;
                case 45:
                case 46:
                case 47:
                    Wc09LexusESAirControlAct.this.updateBtnSource();
                    break;
                case 48:
                    Wc09LexusESAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 49:
                    Wc09LexusESAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 50:
                    Wc09LexusESAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 60:
                    Wc09LexusESAirControlAct.this.mUpdatePowerOn();
                    break;
                case 64:
                    Wc09LexusESAirControlAct.this.mUpdateCycle();
                    break;
                case 65:
                    Wc09LexusESAirControlAct.this.mUpdateDualOn();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0294_wc_09lexus_air_control);
        init();
    }
