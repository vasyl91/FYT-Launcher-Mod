...
public class XCFeiyateFeiyueFrontAirControlAct extends Activity implements View.OnTouchListener {
    ...
    private IUiNotify mNotifyCanbus = new IUiNotify() { 
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                case 8:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdatePowerOn();
                    break;
                case 9:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateAcOn();
                    break;
                case 10:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateAutoOn();
                    break;
                case 11:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateCycle();
                    break;
                case 12:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateRearDefrost();
                    break;
                case 13:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 14:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateDualOn();
                    break;
                case 15:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 16:
                case 17:
                case 18:
                    XCFeiyateFeiyueFrontAirControlAct.this.updateBtnSource();
                    break;
                case 19:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 20:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 21:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdaterSeatHeatLeft();
                    break;
                case 22:
                    XCFeiyateFeiyueFrontAirControlAct.this.mUpdaterSeatHeatRight();
                    break;
                case 54:
                    XCFeiyateFeiyueFrontAirControlAct.this.findViewById(R.id.air_xts_steer_hot).setBackgroundResource(value == 0 ? R.drawable.ic_xts_steer_hot_n : R.drawable.ic_xts_steer_hot_p);
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.layout_0439_xc_feiyatefeiyue_air_control);
        init();
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (id) {
            ...
            case R.id.air_xts_rearpage /* 2131427448 */:
                flag = true;
                try {
                    startActivity(new Intent(this, (Class<?>) XCFeiyateFeiyueRearAirControlAct.class));
                    break;
                } catch (Exception e) {
                    e.printStackTrace();
                    break;
