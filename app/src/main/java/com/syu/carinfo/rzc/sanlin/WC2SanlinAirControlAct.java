...
public class WC2SanlinAirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.sanlin.WC2SanlinAirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 9:
                    WC2SanlinAirControlAct.this.mUpdaterDual();
                    break;
                case 10:
                    WC2SanlinAirControlAct.this.mUpdateAutoOn();
                    break;
                case 11:
                    WC2SanlinAirControlAct.this.mUpdateCycle();
                    break;
                case 13:
                    WC2SanlinAirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 14:
                    WC2SanlinAirControlAct.this.mUpdateRearDefrost();
                    break;
                case 15:
                    WC2SanlinAirControlAct.this.mUpdateAcOn();
                    break;
                case 19:
                    WC2SanlinAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 20:
                    WC2SanlinAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 21:
                case 22:
                case 23:
                    WC2SanlinAirControlAct.this.updateBtnSource();
                    break;
                case 30:
                    WC2SanlinAirControlAct.this.mUpdatePowerOn();
                    break;
                case 31:
                    WC2SanlinAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0443_wc_sanlin_all_air_control);
        init();
    }
