...
public class LZ_NissanInfinitiTireAct extends BaseActivity {
    private IUiNotify notifyCanbus = new IUiNotify() { 
        @Override
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 106:
                    LZ_NissanInfinitiTireAct.this.mUpdaterTireFR();
                    break;
                case 107:
                    LZ_NissanInfinitiTireAct.this.mUpdaterTireFL();
                    break;
                case 108:
                    LZ_NissanInfinitiTireAct.this.mUpdaterTireRL();
                    break;
                case 109:
                    LZ_NissanInfinitiTireAct.this.mUpdaterTireRR();
                    break;
            }
        }
    };
    ...
    public void mUpdaterTireRR() {
        ...
        int sys = (DataCanbus.DATA[109] >> 9) & 1;
        if (sys == 0) {
