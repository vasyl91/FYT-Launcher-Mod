...
public class ODChangAnCS95AirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.changan.ODChangAnCS95AirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 1:
                    ODChangAnCS95AirControlAct.this.mUpdaterDualOn();
                    break;
                case 2:
                    ODChangAnCS95AirControlAct.this.mUpdateAutoOn();
                    break;
                case 3:
                    ODChangAnCS95AirControlAct.this.mUpdateAcOn();
                    break;
                case 4:
                    ODChangAnCS95AirControlAct.this.mUpdateCycle();
                    break;
                case 5:
                    ODChangAnCS95AirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 6:
                    ODChangAnCS95AirControlAct.this.mUpdateRearDefrost();
                    break;
                case 7:
                    ODChangAnCS95AirControlAct.this.mUpdatePowerOn();
                    ODChangAnCS95AirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 8:
                case 9:
                    ODChangAnCS95AirControlAct.this.updateBtnSource();
                    break;
                case 10:
                    ODChangAnCS95AirControlAct.this.mUpdateFrontDefrost();
                    ODChangAnCS95AirControlAct.this.updateBtnSource();
                    break;
                case 12:
                    ODChangAnCS95AirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 13:
                    ODChangAnCS95AirControlAct.this.mUpdateAirTempRight();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0439_od_changancs95_air_control);
        init();
    }
