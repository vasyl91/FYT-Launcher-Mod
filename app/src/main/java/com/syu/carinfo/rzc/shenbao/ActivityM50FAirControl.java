...
public class ActivityM50FAirControl extends Activity implements View.OnClickListener {
    private IUiNotify mNotifyCanbus = new IUiNotify() { 
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                case 11:
                    ActivityM50FAirControl.this.updatePower(value);
                    break;
                case 12:
                    ActivityM50FAirControl.this.updateAC(value);
                    break;
                case 13:
                    ActivityM50FAirControl.this.updateCycle(value);
                    break;
                case 15:
                case 16:
                case 17:
                    ActivityM50FAirControl.this.mUpdataWindType();
                    break;
                case 18:
                    ActivityM50FAirControl.this.updateFront(value);
                    break;
                case 19:
                    ActivityM50FAirControl.this.updateRear(value);
                    break;
                case 20:
                    ActivityM50FAirControl.this.updateWindLevel(value);
                    break;
                case 21:
                    ActivityM50FAirControl.this.updateTemp(value);
                    break;
            }
        }
    };
