...
public class ActRuiTengAirSet extends Activity implements View.OnTouchListener {
    public static ActRuiTengAirSet mInstance;
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.rzc.mingjueruiteng.ActRuiTengAirSet.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 11:
                    ActRuiTengAirSet.this.mUpdateAutoOn();
                    break;
                case 12:
                    ActRuiTengAirSet.this.mUpdateCycle();
                    break;
                case 13:
                    ActRuiTengAirSet.this.mUpdateFrontDefrost();
                    break;
                case 14:
                    ActRuiTengAirSet.this.mUpdateRearDefrost();
                    break;
                case 15:
                    ActRuiTengAirSet.this.mUpdateAcOn();
                    break;
                case 16:
                    ActRuiTengAirSet.this.mUpdateAirTempLeft();
                    if (DataCanbus.DATA[1000] == 2031889) {
                        ActRuiTengAirSet.this.mUpdateAirTempRight();
                        break;
                    }
                case 17:
                case 18:
                case 19:
                    ActRuiTengAirSet.this.updateBtnSource();
                    break;
                case 20:
                    ActRuiTengAirSet.this.mUpdaterAirWindLevelLeft();
                    break;
                case 21:
                    if (DataCanbus.DATA[1000] != 2031889) {
                        ActRuiTengAirSet.this.mUpdateAirTempRight();
                ...
                case 22:
                    ActRuiTengAirSet.this.mUpdatePowerOn();
                    break;
                case 56:
                    ActRuiTengAirSet.this.mUpdaterSeatHeatLeft();
                    break;
                case 57:
                    ActRuiTengAirSet.this.mUpdaterSeatHeatRight();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DataCanbus.DATA[1000] == 2031889) {
            setContentView(R.layout.layout_0273_rzc_mg5_low_control);
        } else {
            setContentView(R.layout.layout_0273_rzc_rongwei_i5_control);
        }
        init();
        mInstance = this;
    }
    ...
    public void mUpdateAirTempLeft() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_left)) != null) {
            if (temp == -2) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_left)).setText((temp * 1.0f) + "°C");
            }
        }
    }
    ...
    public void mUpdateAirTempRight() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_right)) != null) {
            if (temp == -2) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_right)).setText((temp * 1.0f) + "°C");
            }
        }
    }
