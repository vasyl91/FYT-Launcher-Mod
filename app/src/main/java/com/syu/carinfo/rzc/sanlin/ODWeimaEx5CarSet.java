...
public class ODWeimaEx5CarSet extends BaseActivity {
    private SeekBar.OnSeekBarChangeListener mseekbarClick = new SeekBar.OnSeekBarChangeListener() { // from class: com.syu.carinfo.rzc.sanlin.ODWeimaEx5CarSet.1
        ...
        public void onStopTrackingTouch(SeekBar v) {
            switch (v.getId()) {
                case R.id.seekbar_checkedtext1 /* 2131428630 */:
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.ctv_checkedtext1 /* 2131427478 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(1, value);
                    break;
                ...
                case R.id.btn_plus1 /* 2131427482 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(4, value3);
                    break;
                ...
                case R.id.btn_plus2 /* 2131427486 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(5, value5);
                    break;
                case R.id.btn_minus4 /* 2131427492 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(14, value6);
                    break;
                ...
                case R.id.btn_minus5 /* 2131427496 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(15, value8);
                    break;
                case R.id.btn_plus5 /* 2131427498 */:
                    int value9 = DataCanbus.DATA[48] + 1;
                    if (value9 > 1) {
                        value9 = 0;
                    }
                ...
                case R.id.ctv_checkedtext2 /* 2131427531 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(2, value10);
                    break;
                case R.id.ctv_checkedtext3 /* 2131427532 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(3, value11);
                    break;
                case R.id.ctv_checkedtext4 /* 2131427533 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(8, value12);
                    break;
                case R.id.ctv_checkedtext5 /* 2131427537 */:
                    int value13 = DataCanbus.DATA[42];
                    if (value13 == 1) {
                        value13 = 0;
                    } else if (value13 == 0) {
                        value13 = 1;
                    }
                    ODWeimaEx5CarSet.this.setCarInfo(9, value13);
                    break;
                case R.id.ctv_checkedtext6 /* 2131427538 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(10, value14);
                    break;
                case R.id.ctv_checkedtext7 /* 2131427539 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(11, value15);
                    break;
                case R.id.ctv_checkedtext8 /* 2131427540 */:
                    int value16 = DataCanbus.DATA[45];
                    if (value16 == 1) {
                        value16 = 0;
                    } else if (value16 == 0) {
                        value16 = 1;
                    }
                    ODWeimaEx5CarSet.this.setCarInfo(12, value16);
                    break;
                case R.id.ctv_checkedtext9 /* 2131427541 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(13, value17);
                    break;
                case R.id.ctv_checkedtext10 /* 2131427542 */:
                    ...
                    ODWeimaEx5CarSet.this.setCarInfo(7, value18);
                    break;
            }
        }
    };
            ...
            switch (updateCode) {
                ...
                case 48:
                    if (((TextView) ODWeimaEx5CarSet.this.findViewById(R.id.tv_text5)) != null) {
                        switch (value) {
                            case 0:
                                ((TextView) ODWeimaEx5CarSet.this.findViewById(R.id.tv_text4)).setText(R.string.str_unlock);
                                break;
                            case 1:
                                ((TextView) ODWeimaEx5CarSet.this.findViewById(R.id.tv_text4)).setText(R.string.str_lock);
                                break;
                        }
                    }
                    break;
