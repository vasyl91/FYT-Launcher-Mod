...
public class RZC_GMChargeSet4InfoAct extends BaseActivity implements View.OnClickListener {
    IUiNotify mNotifyCanbus = new IUiNotify() { 
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                case 230:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text1)) != null) {
                        switch (value) {
                            case 0:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text1)).setText("6A");
                                break;
                            case 1:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text1)).setText("8A");
                                break;
                        }
                    }
                    break;
                case 231:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)) != null) {
                        switch (value) {
                            case 4:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("40% 192km");
                                break;
                            case 5:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("50% 243km");
                                break;
                            case 6:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("60% 295km");
                                break;
                            case 7:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("70% 347km");
                                break;
                            case 8:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("80% 401km");
                                break;
                            case 9:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("90% 458km");
                                break;
                            case 10:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("100% 518km");
                                break;
                            default:
                                ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text2)).setText("---");
                                break;
                        }
                    }
                    break;
                case 232:
                    RZC_GMChargeSet4InfoAct.this.setCheck((CheckedTextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.ctv_checkedtext1), value == 1);
                    break;
                case 233:
                    RZC_GMChargeSet4InfoAct.this.setCheck((CheckedTextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.ctv_checkedtext2), value == 1);
                    break;
                case 234:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text7)) != null) {
                        ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text7)).setText(String.valueOf(value) + "km");
                        break;
                    }
                case 235:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text3)) != null) {
                        ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text3)).setText(new StringBuilder().append(value).toString());
                        break;
                    }
                case 236:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text4)) != null) {
                        ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text4)).setText(new StringBuilder().append(value).toString());
                        break;
                    }
                case 237:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text5)) != null) {
                        ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text5)).setText(new StringBuilder().append(value).toString());
                        break;
                    }
                case 238:
                    if (((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text6)) != null) {
                        ((TextView) RZC_GMChargeSet4InfoAct.this.findViewById(R.id.tv_text6)).setText(new StringBuilder().append(value).toString());
                        break;
                    }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.layout_0061_rzc_gm_charge_setinf4);
        init();
    }
