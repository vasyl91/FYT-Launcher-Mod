...
public class ODWeiChaiU70AirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.oudi.ODWeiChaiU70AirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 7:
                    ODWeiChaiU70AirControlAct.this.mUpdatePowerOn();
                    break;
                case 8:
                    ODWeiChaiU70AirControlAct.this.mUpdateAcOn();
                    break;
                case 9:
                    ODWeiChaiU70AirControlAct.this.mUpdateCycle();
                    break;
                case 10:
                    ODWeiChaiU70AirControlAct.this.mUpdateAutoOn();
                    break;
                case 11:
                    ODWeiChaiU70AirControlAct.this.mUpdateRearDefrost();
                    break;
                case 12:
                    ODWeiChaiU70AirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 13:
                case 14:
                case 15:
                    ODWeiChaiU70AirControlAct.this.updateBtnSource();
                    break;
                case 16:
                    ODWeiChaiU70AirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 17:
                    ODWeiChaiU70AirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 18:
                    ODWeiChaiU70AirControlAct.this.mUpdateAirTempRight();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0452_od_weichai_air_control);
        init();
    }
        ...
        switch (id) {
            ...
            case R.id.air_xts_front /* 2131427438 */:
                ...
                if (DataCanbus.DATA[12] == 1) {
                    data1 = 2;
                    break;
                } else if (DataCanbus.DATA[12] == 0) {
                    data1 = 1;
                    break;
                }
            case R.id.air_xts_ac /* 2131427439 */:
                data0 = 4;
                if (DataCanbus.DATA[8] == 1) {
                    data1 = 2;
                    break;
                } else if (DataCanbus.DATA[8] == 0) {
                    data1 = 1;
                    break;
                }
