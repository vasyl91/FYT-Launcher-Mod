...
public class ODDx7AirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.xfy.dx7.ODDx7AirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 10:
                    ODDx7AirControlAct.this.mUpdateCycle();
                    break;
                case 11:
                    ODDx7AirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 12:
                    ODDx7AirControlAct.this.mUpdateRearDefrost();
                    break;
                case 13:
                case 14:
                case 36:
                    ODDx7AirControlAct.this.updateBtnSource();
                    break;
                case 15:
                    ODDx7AirControlAct.this.mUpdateAutoOn();
                    break;
                case 16:
                    ODDx7AirControlAct.this.mUpdateAcOn();
                    break;
                case 18:
                    ODDx7AirControlAct.this.mUpdatePowerOn();
                    ODDx7AirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 19:
                    ODDx7AirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 20:
                    ODDx7AirControlAct.this.mUpdateAirTempRight();
                    break;
                case 35:
                    ODDx7AirControlAct.this.mUpdaterDual();
                    break;
            }
        }
    };
    ...
    private void sendCmd(int data0, int data1) {
        DataCanbus.PROXY.cmd(7, new int[]{data0, data1}, null, null);
    }

    @Override // android.app.Activity
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_0329_od_dx7_air_control);
        init();
    }
