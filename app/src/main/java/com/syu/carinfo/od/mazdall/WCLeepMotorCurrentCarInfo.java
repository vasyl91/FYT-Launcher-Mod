            ...
            switch (updateCode) {
                case 99:
                    if (value == 65535) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text1)).setText(value / 10 + "." + (value % 10) + " kWh/100km");
                        break;
                    }
                case 100:
                    if (value == 16777215) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text2)).setText(value / 10 + "." + (value % 10) + " km");
                        break;
                    }
                case 101:
                    ...
                    if (value == 16777215) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text3)).setText(hour / 10 + "H" + min + "M");
                        break;
                    }
                case 102:
                    if (value == 255) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text4)).setText(value + "%");
                        break;
                    }
                case 103:
                    if (value == 255) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text5)).setText(value + "%");
                        break;
                    }
                case 104:
                    if (value == 255) {
                        ...
                        ((TextView) WCLeepMotorCurrentCarInfo.this.findViewById(R.id.tv_text6)).setText(value + "%");
                        break;
                    }
            }
        }
