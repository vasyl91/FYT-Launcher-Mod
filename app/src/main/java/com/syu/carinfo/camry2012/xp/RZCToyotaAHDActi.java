...
public class RZCToyotaAHDActi extends BaseActivity implements View.OnTouchListener {
    private IUiNotify mNotifyCanbus = new IUiNotify() { 
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            ...
            switch (updateCode) {
                case 256:
                    ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text13)).setText(new StringBuilder().append(value).toString());
                    break;
                case 257:
                    switch (value) {
                        case 1:
                            ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text14)).setText(R.string.str_centered);
                            break;
                        case 2:
                            ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text14)).setText(R.string.str_full_screen);
                            break;
                    }
                case 258:
                    switch (value) {
                        case 6:
                            ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text15)).setText("1280x720@30Hz");
                            break;
                        case 7:
                            ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text15)).setText("1280x720@25Hz");
                            break;
                    }
                case 259:
                    if ((value & 128) != 0) {
                        ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text16)).setText("-" + (256 - value));
                        break;
                    } else {
                        ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text16)).setText("+" + value);
                        break;
                    }
                case 260:
                    if ((value & 128) != 0) {
                        ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text17)).setText("-" + (256 - value));
                        break;
                    } else {
                        ((TextView) RZCToyotaAHDActi.this.findViewById(R.id.tv_text17)).setText("+" + value);
                        break;
                    }
            }
        }
        ...
        if (event.getAction() == 0) {
            switch (v.getId()) {
                case R.id.btn_minus13 /* 2131427491 */:
                    int d2 = DataCanbus.DATA[256];
                    int d3 = DataCanbus.DATA[257];
                    int d4 = DataCanbus.DATA[258];
                    if (d2 > 0) {
                        d2--;
                    }
                    setCarInfo1(0, d2, d3, d4, 0, 0);
                case R.id.btn_plus13 /* 2131427493 */:
                    int d22 = DataCanbus.DATA[256];
                    int d32 = DataCanbus.DATA[257];
                    int d42 = DataCanbus.DATA[258];
                    if (d22 < 5) {
                        d22++;
                    }
                    setCarInfo1(0, d22, d32, d42, 0, 0);
                case R.id.btn_minus14 /* 2131427494 */:
                    int d23 = DataCanbus.DATA[256];
                    int d33 = DataCanbus.DATA[257];
                    int d43 = DataCanbus.DATA[258];
                    int d34 = d33 - 1;
                    if (d34 < 1) {
                        d34 = 2;
                    }
                ...
                case R.id.btn_plus14 /* 2131427496 */:
                    int d24 = DataCanbus.DATA[256];
                    int d35 = DataCanbus.DATA[257];
                    int d44 = DataCanbus.DATA[258];
                    int d36 = d35 + 1;
                    if (d36 > 2) {
                        d36 = 1;
                    }
                ...
                case R.id.btn_minus15 /* 2131427515 */:
                    int d25 = DataCanbus.DATA[256];
                    int d37 = DataCanbus.DATA[257];
                    int d45 = DataCanbus.DATA[258];
                    int d46 = d45 - 1;
                    if (d46 < 6) {
                        d46 = 7;
                    }
                ...
                case R.id.btn_plus15 /* 2131427517 */:
                    int d26 = DataCanbus.DATA[256];
                    int d38 = DataCanbus.DATA[257];
                    int d47 = DataCanbus.DATA[258];
                    int d48 = d47 + 1;
                    if (d48 > 7) {
                        d48 = 6;
                    }
                ...
                case R.id.btn_minus16 /* 2131427518 */:
                    int d27 = DataCanbus.DATA[256];
                    int d39 = DataCanbus.DATA[257];
                    int d49 = DataCanbus.DATA[258];
                    setCarInfo1(0, d27, d39, d49, 1, 0);
                case R.id.btn_plus16 /* 2131427520 */:
                    int d28 = DataCanbus.DATA[256];
                    int d310 = DataCanbus.DATA[257];
                    int d410 = DataCanbus.DATA[258];
                    setCarInfo1(0, d28, d310, d410, 2, 0);
                case R.id.btn_minus17 /* 2131427521 */:
                    int d29 = DataCanbus.DATA[256];
                    int d311 = DataCanbus.DATA[257];
                    int d411 = DataCanbus.DATA[258];
                    setCarInfo1(0, d29, d311, d411, 0, 1);
                case R.id.btn_plus17 /* 2131427523 */:
                    int d210 = DataCanbus.DATA[256];
                    int d312 = DataCanbus.DATA[257];
                    int d412 = DataCanbus.DATA[258];
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_minus17 /* 2131427521 */:
                case R.id.btn_plus17 /* 2131427523 */:
                    int d211 = DataCanbus.DATA[256];
                    int d313 = DataCanbus.DATA[257];
                    int d413 = DataCanbus.DATA[258];
    ...
    public void setCarInfo1(int value1, int value2, int value3, int value4, int value5, int value6) {
        DataCanbus.PROXY.cmd(49, new int[]{value1, value2, value3, value4, value5, value6}, null, null);
    }
