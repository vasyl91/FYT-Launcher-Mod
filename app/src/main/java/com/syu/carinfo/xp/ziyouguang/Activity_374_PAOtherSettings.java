...
public class Activity_374_PAOtherSettings extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(0, 365, R.string.str_fuel_saver_display_in_cluster);
        carInfo.setCmd(0, 2);
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(1, 366, R.string.str_fwd_collision_sensitivity);
        carInfo2.setCmd(0, 96);
        carInfo2.setDiplsys(new String[]{"OFF", "NEAR", "FAR"});
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 367, R.string.str_park_assist);
        carInfo3.setCmd(0, 97);
        carInfo3.setDiplsys(new String[]{"OFF", "Sound", "Sound+display"});
        this.mList.add(carInfo3);
        CarInfo carInfo4 = new CarInfo(0, 368, R.string.str_steering_directed_headlights);
        carInfo4.setCmd(0, 98);
        this.mList.add(carInfo4);
        CarInfo carInfo5 = new CarInfo(0, 369, R.string.str_auto_on_driver_heated);
        carInfo5.setCmd(0, 99);
        this.mList.add(carInfo5);
        CarInfo carInfo6 = new CarInfo(0, 370, R.string.str_srt_mode);
        carInfo6.setCmd(0, 100);
        this.mList.add(carInfo6);
        CarInfo carInfo7 = new CarInfo(1, 402, R.string.rzc_side_stop_assit_str);
        carInfo7.setCmd(0, 102);
        carInfo7.setDiplsys(new String[]{"OFF", "Sound", "Sound+display"});
        this.mList.add(carInfo7);
        CarInfo carInfo8 = new CarInfo(1, 403, R.string.rzc_side_stop_assit_str);
        ...
        CarInfo carInfo9 = new CarInfo(1, 405, R.string.str_107_str1);
