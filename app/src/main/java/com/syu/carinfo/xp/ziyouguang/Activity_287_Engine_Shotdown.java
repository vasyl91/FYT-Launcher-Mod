...
public class Activity_287_Engine_Shotdown extends Activity {
    ...
    private void initValue() {
        CarInfo carInfo = new CarInfo(1, 8, R.string.str_shutdown_mode);
        carInfo.setCmd(0, 67);
        carInfo.setDiplsys(new String[]{"Acc off + Door open", "Acc off"});
        this.mList.add(carInfo);
        CarInfo carInfo2 = new CarInfo(0, 9, R.string.str_151_amp);
        carInfo2.setCmd(1, 1);
        this.mList.add(carInfo2);
        CarInfo carInfo3 = new CarInfo(1, 10, R.string.str_sbd_x80_yuanche_vol);
        carInfo3.setCmd(1, 2);
