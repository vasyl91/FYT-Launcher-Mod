...
public class XCRuijieAirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.hc.ruijie.XCRuijieAirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 8:
                    XCRuijieAirControlAct.this.mUpdatePowerOn();
                    break;
                case 9:
                    XCRuijieAirControlAct.this.mUpdateAcOn();
                    break;
                case 10:
                    XCRuijieAirControlAct.this.mUpdateAutoOn();
                    break;
                case 11:
                    XCRuijieAirControlAct.this.mUpdateCycle();
                    break;
                case 12:
                    XCRuijieAirControlAct.this.mUpdateRearDefrost();
                    break;
                case 14:
                    XCRuijieAirControlAct.this.mUpdaterDual();
                    break;
                case 15:
                    XCRuijieAirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 16:
                    XCRuijieAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 18:
                    XCRuijieAirControlAct.this.mUpdateFrontDefrost();
                    XCRuijieAirControlAct.this.updateBtnSource();
                    break;
                case 19:
                    XCRuijieAirControlAct.this.updateBtnSource();
                    break;
                case 22:
                    XCRuijieAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 23:
                    XCRuijieAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 24:
                    XCRuijieAirControlAct.this.mUpdaterSeatHeatOrWinLeft();
                    break;
                case 25:
                    XCRuijieAirControlAct.this.mUpdaterSeatHeatOrWinRight();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0439_xc_ruijie_air_control);
        init();
    }
    ...
    public void mUpdaterDual() {
        ...
        findViewById(R.id.air_xts_dual).setBackgroundResource(power == 0 ? R.drawable.ic_xts_sync_n : R.drawable.ic_xts_sync_p);
    }
    ...
    public void mUpdateAirTempLeft() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_left)) != null) {
            ...
            if (temp == -3) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_left)).setText(((((temp - 12) * 5) + 155) * 0.1f) + "°C");
            } else {
    ...
    public void mUpdateAirTempRight() {
        ...
        if (((TextView) findViewById(R.id.tv_air_temp_right)) != null) {
            ...
            if (temp == -3) {
                ...
                ((TextView) findViewById(R.id.tv_air_temp_right)).setText(((((temp - 12) * 5) + 155) * 0.1f) + "°C");
            } else {
