...
public class WcXTSAirControlAct extends Activity implements View.OnTouchListener {
        ...
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                ...
                case 28:
                    ...
                    break;
                case 29:
                    WcXTSAirControlAct.this.mUpdateAirSeatHotLeft();
                    break;
                case 30:
                    WcXTSAirControlAct.this.mUpdateAirSeatHotRight();
                    break;
                case 31:
                    WcXTSAirControlAct.this.mUpdateAirSeatBlowLeft();
                    break;
                case 32:
                    WcXTSAirControlAct.this.mUpdateAirSeatBlowRight();
                    break;
                case 49:
    ...
    public void mUpdateAirSeatBlowRight() {
    ...
    public void mUpdateAirSeatBlowLeft() {
