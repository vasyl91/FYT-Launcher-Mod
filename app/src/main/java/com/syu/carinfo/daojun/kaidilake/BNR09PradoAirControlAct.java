...
public class BNR09PradoAirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.daojun.kaidilake.BNR09PradoAirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 1:
                    BNR09PradoAirControlAct.this.mUpdatePowerOn();
                    break;
                case 2:
                    BNR09PradoAirControlAct.this.mUpdateAcOn();
                    break;
                case 3:
                    BNR09PradoAirControlAct.this.mUpdateCycle();
                    break;
                case 4:
                    BNR09PradoAirControlAct.this.mUpdateAutoOn();
                    break;
                case 5:
                    BNR09PradoAirControlAct.this.mUpdaterDual();
                    break;
                case 6:
                    BNR09PradoAirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 7:
                case 8:
                case 9:
                    BNR09PradoAirControlAct.this.updateBtnSource();
                    break;
                case 10:
                    BNR09PradoAirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 11:
                    BNR09PradoAirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 12:
                    BNR09PradoAirControlAct.this.mUpdateAirTempRight();
                    break;
                case 14:
                    BNR09PradoAirControlAct.this.mUpdateRearDefrost();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0439_bnr_09prado_air_control);
        init();
    }
