...
public class ODKaiyiX3AirControlAct extends Activity implements View.OnTouchListener {
    public static boolean mIsFront = false;
    private IUiNotify mNotifyCanbus = new IUiNotify() { // from class: com.syu.carinfo.daojun.kaidilake.ODKaiyiX3AirControlAct.1
        @Override // com.syu.module.IUiNotify
        public void onNotify(int updateCode, int[] ints, float[] flts, String[] strs) {
            switch (updateCode) {
                case 7:
                    ODKaiyiX3AirControlAct.this.mUpdatePowerOn();
                    break;
                case 8:
                    ODKaiyiX3AirControlAct.this.mUpdateAcOn();
                    break;
                case 9:
                    ODKaiyiX3AirControlAct.this.mUpdateCycle();
                    break;
                case 13:
                    ODKaiyiX3AirControlAct.this.mUpdateFrontDefrost();
                    break;
                case 14:
                    ODKaiyiX3AirControlAct.this.mUpdateRearDefrost();
                    break;
                case 15:
                case 16:
                case 17:
                    ODKaiyiX3AirControlAct.this.updateBtnSource();
                    break;
                case 18:
                    ODKaiyiX3AirControlAct.this.mUpdaterAirWindLevelLeft();
                    break;
                case 19:
                    ODKaiyiX3AirControlAct.this.mUpdateAirTempLeft();
                    break;
                case 20:
                    ODKaiyiX3AirControlAct.this.mUpdateAirTempRight();
                    break;
                case 21:
                    ODKaiyiX3AirControlAct.this.mUpdaterSeatHeatLeft();
                    break;
                case 22:
                    ODKaiyiX3AirControlAct.this.mUpdaterSeatHeatRight();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_0452_od_kaiyix3_air_control);
        init();
    }
    ...
    protected void onResume() {
        super.onResume();
        mIsFront = true;
        DataCanbus.PROXY.cmd(1, new int[]{33}, null, null);
        addUpdater();
