...
public class Callback_0206_WC1_Benz extends CallbackCanbusBase {
    ...
    public static final int U_AIR_CONTROL = 23;
    ...
    public static final int U_AIR_WIND_LEVEL_HALF_LEFT = 24;
    public static final int U_AIR_WIND_LEVEL_HALF_RIGHT = 30;
    public static final int U_AIR_WIND_LEVEL_LEFT = 19;
    public static final int U_AIR_WIND_LEVEL_RIGHT = 29;
    public static final int U_CNT_MAX = 34;
    public static final int U_SEAT_BELT_LEFT = 32;
    public static final int U_SEAT_BELT_RIGHT = 33;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0206_WC1_Benz(LauncherApplication.getInstance()));
