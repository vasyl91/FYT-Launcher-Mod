...
public class Callback_0345_WC2_ShuPingJunWei extends CallbackCanbusBase {
    ...
    public static final int U_AIR_TEMP_OUT = 193;
    ...
    public static final int U_ANJIXING_PHONE_NUMBER = 189;
    ...
    public static final int U_ANJIXING_TTS = 187;
    public static final int U_ANJIXING_TTS_SHOW = 188;
    public static final int U_ANJIXING_WARN_TYPE = 158;
    public static final int U_AUTO_CRUISE_CONTROL = 195;
    ...
    public static final int U_BATTERY_VOLTAGE = 191;
    ...
    public static final int U_CAR_HANDBREAK_STATE = 190;
    ...
    public static final int U_CUR_SPEED = 196;
    ...
    public static final int U_ENGINE_SPEED = 197;
    public static final int U_FANGZHUANG_WARN_TYPE_SET = 114;
    public static final int U_FORGET_KEY = 138;
    public static final int U_FRONT_LEFT_HIGH_WARN_INFO = 172;
    public static final int U_FRONT_LEFT_LOW_WARN_INFO = 173;
    public static final int U_FRONT_LEFT_PRESS = 168;
    public static final int U_FRONT_LEFT_WARN_INFO = 174;
    public static final int U_FRONT_RIGHT_HIGH_WARN_INFO = 175;
    public static final int U_FRONT_RIGHT_LOW_WARN_INFO = 176;
    public static final int U_FRONT_RIGHT_PRESS = 169;
    public static final int U_FRONT_RIGHT_WARN_INFO = 177;
    public static final int U_LEARVER_CAR_LOCK = 137;
    public static final int U_LOCATION_LIGHTS = 186;
    ...
    public static final int U_PREVENT_ANTI_LOCK = 185;
    public static final int U_PREVENT_AUTO_LUOSUO = 124;
    public static final int U_REAR_LEFT_HIGH_WARN_INFO = 178;
    public static final int U_REAR_LEFT_LOW_WARN_INFO = 179;
    public static final int U_REAR_LEFT_PRESS = 170;
    public static final int U_REAR_LEFT_WARN_INFO = 180;
    public static final int U_REAR_RIGHT_HIGH_WARN_INFO = 181;
    public static final int U_REAR_RIGHT_LOW_WARN_INFO = 182;
    public static final int U_REAR_RIGHT_PRESS = 171;
    public static final int U_REAR_RIGHT_WARN_INFO = 183;
    ...
    public static final int U_SETTING_ASSIST = 194;
    ...
    public static final int U_TOTAL_TRAVEL_MILES = 192;
    public static final int U_WARN_ENABLE = 184;
