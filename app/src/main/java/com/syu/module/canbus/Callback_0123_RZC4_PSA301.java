...
public class Callback_0123_RZC4_PSA301 extends CallbackCanbusBase {
    ...
    public void update(int updateCode, int[] ints, float[] flts, String[] strs) throws RemoteException {
        if (updateCode >= 0 && updateCode < 96) {
            ...
            if (updateCode == 67) {
                HandlerCanbus.update(updateCode, ints);
                int value3 = DataCanbus.DATA[67];
                if (value3 != 0 && !BZ408OilMileIndexActi.mIsFront) {
                    JumpPage.startActivity("com.syu.canbus", "com.syu.carinfo.rzc.biaozhi408.BZ408OilMileIndexActi");
                    return;
                } else {
                    if (value3 == 0 && BZ408OilMileIndexActi.mIsFront && BZ408OilMileIndexActi.mInstance != null) {
