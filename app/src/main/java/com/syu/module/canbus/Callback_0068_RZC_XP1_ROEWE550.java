...
public class Callback_0068_RZC_XP1_ROEWE550 extends CallbackCanbusBase {
    ...
    public static final int U_AIR_DUAL = 24;
    ...
    public static final int U_CAR_DASHBOARD_COLOR = 26;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0068_RZC_RoeWe550(LauncherApplication.getInstance()));
