...
public class Callback_0452_OD_HZ_Nezha extends CallbackCanbusBase {
    ...
    public static final int U_AIR_ACMAX = 11;
    ...
    public static final int U_AIR_ENERGY_CYCLE = 23;
    public static final int U_AIR_FRONT_DEFROST = 14;
    public static final int U_AIR_HOT = 22;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0452_OD_HZ_Nezha(LauncherApplication.getInstance()));
