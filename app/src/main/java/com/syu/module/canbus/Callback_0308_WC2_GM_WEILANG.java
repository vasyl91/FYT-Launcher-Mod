...
public class Callback_0308_WC2_GM_WEILANG extends CallbackCanbusBase {
    ...
    public static final int U_CUR_SPEED = 187;
    ...
    public static final int U_ENGINE_SPEED = 186;
    public static final int U_FANGZHUANG_WARN_TYPE_SET = 114;
    public static final int U_FORGET_KEY = 138;
    public static final int U_FRONT_LEFT_HIGH_WARN_INFO = 173;
    public static final int U_FRONT_LEFT_LOW_WARN_INFO = 174;
    public static final int U_FRONT_LEFT_PRESS = 169;
    public static final int U_FRONT_LEFT_WARN_INFO = 175;
    public static final int U_FRONT_RIGHT_HIGH_WARN_INFO = 176;
    public static final int U_FRONT_RIGHT_LOW_WARN_INFO = 177;
    public static final int U_FRONT_RIGHT_PRESS = 170;
    public static final int U_FRONT_RIGHT_WARN_INFO = 178;
    ...
    public static final int U_REAR_LEFT_HIGH_WARN_INFO = 179;
    public static final int U_REAR_LEFT_LOW_WARN_INFO = 180;
    public static final int U_REAR_LEFT_PRESS = 171;
    public static final int U_REAR_LEFT_WARN_INFO = 181;
    public static final int U_REAR_RIGHT_HIGH_WARN_INFO = 182;
    public static final int U_REAR_RIGHT_LOW_WARN_INFO = 183;
    public static final int U_REAR_RIGHT_PRESS = 172;
    public static final int U_REAR_RIGHT_WARN_INFO = 184;
    ...
    public static final int U_SETTING_ASSIST = 168;
    ...
    public static final int U_WARN_ENABLE = 185;
    ...
    public void in() {
        ...
        //AirHelper.getInstance().buildUi(new Air_0308_WC2_15WEILANG(LauncherApplication.getInstance()));
