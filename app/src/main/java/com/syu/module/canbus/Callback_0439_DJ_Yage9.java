...
public class Callback_0439_DJ_Yage9 extends CallbackCanbusBase {
    ...
    public static final int U_AIR_AC_AUTO = 14;
    ...
    public static final int U_TURN_RIGHT_ENTER_CAMERA = 22;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0439_DJ_Yage9(LauncherApplication.getInstance()));
