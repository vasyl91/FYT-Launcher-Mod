...
public class Callback_0439_DJ_MAZIDA6 extends CallbackCanbusBase {
    ...
    public static final int U_AIR_AMB = 9;
    ...
    public static final int U_AIR_TEMP_AMB = 16;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0439_DJ_MAZIDA6(LauncherApplication.getInstance()));
