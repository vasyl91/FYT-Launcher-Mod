...
public class Callback_0452_XC_Nissan_Tule extends CallbackCanbusBase {
    public static final int U_CARINFO_AVG_OIL = 109;
    public static final int U_CARINFO_MILE = 108;
    public static final int U_CARINFO_TOTAL_MILE = 107;
    ...
    public static final int U_CUR_MOTOR_SPEED = 110;
