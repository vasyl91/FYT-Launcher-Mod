...
public class Callback_0168_XP1_SoNaTa extends CallbackCanbusBase {
    public static final int U_AIR_AC = 25;
    ...
    public static final int U_AIR_MAX_FRONT = 27;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0168_Xp2_SuoLaTa(LauncherApplication.getInstance()));
