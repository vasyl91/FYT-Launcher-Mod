...
public class Callback_0225_XP1_SanLinPajero extends CallbackCanbusBase {
    ...
    public static final int U_AIR_AUTO = 27;
    public static final int U_AIR_BEGIN = 10;
    public static final int U_AIR_BIG_WIND_LIGHT = 14;
    ...
    public static final int U_AIR_LITTLE_WIND_LIGHT = 15;
    public static final int U_AIR_MAX = 17;
    public static final int U_AIR_POWER = 11;
    public static final int U_AIR_REAR_DEFROST = 28;
    public static final int U_AIR_SEAT_HEAT_LEFT = 25;
    public static final int U_AIR_SEAT_HEAT_RIGHT = 26;
