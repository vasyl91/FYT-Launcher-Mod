...
public class Callback_0452_RZC_BisuT5 extends CallbackCanbusBase {
    ...
    public static final int U_AIR_POWER_BACK = 21;
    ...
    public static final int U_AIR_WIND_LEVEL_BACK = 22;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0452_RZC_BisuT5(LauncherApplication.getInstance()));
