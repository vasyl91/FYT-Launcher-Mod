...
public class Callback_0443_WC2_Nazhijie_U6 extends CallbackCanbusBase {
    public static final int U_CARSET_NEXT_MILE = 100;
    public static final int U_CARSET_NEXT_MILE_DISTANCE = 101;
    public static final int U_CARSET_PREV_MILE = 99;
    public static final int U_CARSET_SIDE_VIDEO = 98;
