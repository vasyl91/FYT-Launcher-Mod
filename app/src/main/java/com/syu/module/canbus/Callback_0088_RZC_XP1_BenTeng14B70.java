...
public class Callback_0088_RZC_XP1_BenTeng14B70 extends CallbackCanbusBase {
    ...
    public static final int U_AIR_ECO = 14;
    ...
    public static final int U_AIR_SEAT_HEAT_LEFT = 12;
    public static final int U_AIR_SEAT_HEAT_RIGHT = 13;
    ...
    public void in() {
        ...
        AirHelper.getInstance().buildUi(new Air_0088_FYTA_RZC_XP1_BenTeng14B70(LauncherApplication.getInstance()));
