...
public class Air_0453_XC_Ford_EDGE extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[37] != 0) {
            c.clipRect(89.0f, 34.0f, 135.0f, 75.0f, Region.Op.UNION);
            c.clipRect(972.0f, 34.0f, 1014.0f, 76.0f, Region.Op.UNION);
        }
        ...
        switch (value3) {
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(value3 / 10 + "." + (value3 % 10), 51.0f, 67.0f, this.mPaint);
                break;
        }
        ...
        switch (value4) {
            ...
            case -1:
                ...
                break;
            default:
                c.drawText(value4 / 10 + "." + (value4 % 10), 940.0f, 67.0f, this.mPaint);
                break;
        }
        canvas.save();
