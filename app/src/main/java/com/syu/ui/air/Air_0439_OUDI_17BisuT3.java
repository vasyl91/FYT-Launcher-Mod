...
public class Air_0439_OUDI_17BisuT3 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(temp + 60 + "℉", 70.0f, 60.0f, this.mPaint);
        } else {
            int temp2 = ((temp * 5) + 160) & 65535;
            c.drawText(temp2 / 10 + "." + (temp2 % 10) + " ℃", 70.0f, 60.0f, this.mPaint);
        }
        ...
        if (temp1 == -1) {
            ...
            c.drawText(temp1 + 60 + "℉", 920.0f, 60.0f, this.mPaint);
        } else {
            int temp12 = ((temp1 * 5) + 160) & 65535;
            c.drawText(temp12 / 10 + "." + (temp12 % 10) + " ℃", 920.0f, 60.0f, this.mPaint);
        }
        canvas.save();
