...
public class Air_0429_DJ_XP1_TOYOTA_12Crown extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(String.valueOf(temp), 76.0f, 72.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(String.valueOf(temp2 / 2.0f), 920.0f, 72.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(temp2), 920.0f, 72.0f, this.mPaint);
        }
