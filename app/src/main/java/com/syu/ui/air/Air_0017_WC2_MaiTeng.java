...
public class Air_0017_WC2_MaiTeng extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 254) {
            ...
            c.drawText(String.valueOf((temp * 5) / 10.0f), 50.0f, 72.0f, this.mPaint);
        }
        ...
        if (temp2 == 254) {
            ...
            c.drawText(String.valueOf((temp2 * 5) / 10.0f), 950.0f, 72.0f, this.mPaint);
        }
        ...
        if (temp3 == 254) {
            ...
            c.drawText(String.valueOf((temp3 * 5) / 10.0f), 690.0f, 72.0f, this.mPaint);
        }
        canvas.save();
