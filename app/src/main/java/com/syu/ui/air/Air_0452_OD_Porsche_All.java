...
public class Air_0452_OD_Porsche_All extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 0) {
            ...
            c.drawText(String.valueOf((temp + 59)), 65.0f, 140.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(((temp * 5) + 155) / 10.0f), 65.0f, 140.0f, this.mPaint);
        }
        ...
        if (temp2 == 0) {
            ...
            c.drawText(String.valueOf((temp2 + 59)), 930.0f, 140.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(((temp2 * 5) + 155) / 10.0f), 930.0f, 140.0f, this.mPaint);
        }
        canvas.save();
