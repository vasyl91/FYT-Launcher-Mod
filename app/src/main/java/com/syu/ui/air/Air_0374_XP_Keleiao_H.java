...
public class Air_0374_XP_Keleiao_H extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[62] != 0) {
            c.clipRect(694.0f, 22.0f, 806.0f, 75.0f, Region.Op.UNION);
        }
        if (this.DATA[12] != 1) {
            c.clipRect(182.0f, 8.0f, 333.0f, 63.0f, Region.Op.UNION);
        }
        if (this.DATA[36] != 1) {
            c.clipRect(227.0f, 63.0f, 296.0f, 82.0f, Region.Op.UNION);
        }
        if (this.DATA[15] != 0) {
        ...
        c.clipRect(698.0f, 109.0f, (value * 16) + 698, 164.0f, Region.Op.UNION);
