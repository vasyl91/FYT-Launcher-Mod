...
public class Air_0396_RZC_ShengBaoM50F extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == 0) {
            ...
            c.drawText(new StringBuilder().append(temp + 59).toString(), 930.0f, 152.0f, this.mPaint);
        } else {
            c.drawText(new StringBuilder().append(((temp * 5) + 155) / 10.0f).toString(), 930.0f, 152.0f, this.mPaint);
        }
        canvas.save();
