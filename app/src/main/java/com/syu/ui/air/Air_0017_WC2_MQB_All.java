...
public class Air_0017_WC2_MQB_All extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[157] == 0) {
            c.clipRect(826.0f, 138.0f, 913.0f, 182.0f, Region.Op.UNION);
        }
        if (this.DATA[153] != 0) {
        ...
        if (this.DATA[204] != 0) {
            c.clipRect(519.0f, 248.0f, 551.0f, 276.0f, Region.Op.UNION);
        }
        if (this.DATA[207] != 0) {
        ...
        c.clipRect(676.0f, 133.0f, 676.0f + (value * 15.5f), 178.0f, Region.Op.UNION);
        ...
        c.clipRect(968.0f - (value6 * 14.0f), 152.0f, 968.0f, 180.0f, Region.Op.UNION);
