...
public class Air_0452_LUZ_SUBARU extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -2) {
            ...
            c.drawText(((temp * 9) + 320) / 10.0f + " ℉", 59.0f, 108.0f, this.mPaint);
        } else {
            c.drawText(temp / 2.0f + " ℃", 59.0f, 108.0f, this.mPaint);
        }
        ...
        if (temp2 == -2) {
            ...
            c.drawText(((temp2 * 9) + 320) / 10.0f + " ℉", 956.0f, 108.0f, this.mPaint);
        } else {
            c.drawText(temp2 / 2.0f + " ℃", 956.0f, 108.0f, this.mPaint);
        }
        canvas.save();
