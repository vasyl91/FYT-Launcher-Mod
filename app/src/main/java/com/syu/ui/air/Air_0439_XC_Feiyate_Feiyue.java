...
public class Air_0439_XC_Feiyate_Feiyue extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.DATA[19] >= 60 && this.DATA[19] <= 84) {
            c.clipRect(66.0f, 41.0f, 101.0f, 85.0f, Region.Op.UNION);
        }
        if (this.DATA[20] >= 60 && this.DATA[20] <= 84) {
        ...
        if (temp1 == -1) {
            ...
            c.drawText(String.valueOf(temp1), 614.0f, 73.0f, this.mPaint);
        }
        int temp2 = this.DATA[29];
        if (temp2 == -1) {
            ...
            c.drawText(temp2 + "℉", 974.0f, 73.0f, this.mPaint);
        } else {
            c.drawText(temp2 + "℃", 974.0f, 73.0f, this.mPaint);
        }
        canvas.save();
