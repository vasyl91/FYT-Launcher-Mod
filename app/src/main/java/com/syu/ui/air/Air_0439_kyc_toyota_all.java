...
public class Air_0439_kyc_toyota_all extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(String.valueOf(temp + 31), 70.0f, 135.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf((temp * 5) / 10.0f), 70.0f, 135.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(String.valueOf(temp2 + 31), 915.0f, 135.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf((temp2 * 5) / 10.0f), 915.0f, 135.0f, this.mPaint);
        }
        canvas.save();
