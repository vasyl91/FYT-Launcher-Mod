...
public class Air_0132H_WC2_HavaH2 extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(String.valueOf(temp / 2.0f), 72.0f, 148.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(temp), 72.0f, 148.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(String.valueOf(temp2 / 2.0f), 940.0f, 148.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(temp2), 940.0f, 148.0f, this.mPaint);
        }
        canvas.save();
