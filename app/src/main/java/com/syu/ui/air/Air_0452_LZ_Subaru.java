...
public class Air_0452_LZ_Subaru extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int temp = this.DATA[19] + (this.DATA[63] * 2);
        if (temp == -1) {
            ...
            c.drawText(String.valueOf((((temp + 8) * 9) + 320) / 10), 70.0f, 135.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(temp / 2.0f), 70.0f, 135.0f, this.mPaint);
        }
        int temp2 = this.DATA[20] + (this.DATA[64] * 2);
        if (temp2 == -1) {
            ...
            c.drawText(String.valueOf((((temp2 + 8) * 9) + 320) / 10), 915.0f, 135.0f, this.mPaint);
        } else {
            c.drawText(String.valueOf(temp2 / 2.0f), 915.0f, 135.0f, this.mPaint);
        }
        canvas.save();
