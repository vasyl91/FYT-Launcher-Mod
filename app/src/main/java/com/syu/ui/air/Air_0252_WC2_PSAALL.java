...
public class Air_0252_WC2_PSAALL extends AirBase {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (temp == -1) {
            ...
            c.drawText(String.valueOf((temp + (tempvalue * 10)) / 10.0f), 56.0f, 150.0f, this.mPaint);
        }
        ...
        if (temp2 == -1) {
            ...
            c.drawText(String.valueOf((temp2 + (tempvalue * 10)) / 10.0f), 920.0f, 150.0f, this.mPaint);
        }
        canvas.save();
