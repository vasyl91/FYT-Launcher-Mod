...
public class BackgroundWidgetsSelectorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.widgets_background_selector, null);

        setSystemWallpaperAsBackground(view);
        
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(requireContext());
        selectedBackground = sharedPreferences.getString(Keys.WIDGETS_SELECTED_BACKGROUND, "bg_custom");
        
        gridLayout = view.findViewById(R.id.widgets_background_grid);
        Button cancelButton = view.findViewById(R.id.widgets_background_cancel_button);
    ...
    private void setupGrid() {
        ...
        for (String bgName : backgroundNames) {
            ...
            cardView.setOnClickListener(v -> {
                ...
                sharedPreferences.edit().putString(Keys.WIDGETS_SELECTED_BACKGROUND, bgName).apply();
                dismiss();
            });
