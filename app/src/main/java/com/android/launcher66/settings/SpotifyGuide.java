...
public class SpotifyGuide extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.setTitle(getString(R.string.spotify_category)); 
        }
        ...
        items.add(new TitleItem(getString(R.string.spotify_dev_site)));
        if (SettingsActivity.orientation  == Configuration.ORIENTATION_LANDSCAPE) {
            items.add(new SpotifyItem(R.drawable.spotify_horizontal));
        } else {
            items.add(new SpotifyItem(R.drawable.spotify_vertical));
        }
