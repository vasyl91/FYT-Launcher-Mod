...
public class CorrectionSeekBarPreference extends Preference {
    ...
    public CorrectionSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(R.layout.seekbar_preference_correction); // Custom layout for the SeekBar
    }
