...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    private boolean mUninstallSuccessful;
     ...
     private ShortcutInfo mDelayRemoveItem;
    ...
    public void doneEditingFolderName(boolean commit) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(()-> {
            if (!helpers.isFirstPreferenceWindow() 
                ...
                && mLauncher != null && mLauncher.mAppsCustomizeTabHost != null
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (successfulDrop) {
            ...
            ComponentName cn = ((ShortcutInfo) d.dragInfo).intent.getComponent();
            if (cn != null) {
                resolveInfos = AllAppsList.findActivitiesForPackage(getContext(), cn.getPackageName());
            } else {
                resolveInfos = AllAppsList.findActivitysByIntent(getContext(), ((ShortcutInfo) d.dragInfo).intent);
            }
        ...
        if (mDelayRemoveItem != null) {
            onRemove(mDelayRemoveItem);
        }
    ...
    private void centerAboutIcon() {
        ...
        // sometiem Launcher will be recreate but Folder has uncomplete animation.
        // when cancel the animation in Launcher.onDestroy will cause this function
        // be called, but workspace may be set to null now.
        ...
        if (currentLayout != null) {
            ...
            Log.d(TAG, "Folder.centerAboutIcon, workspace no child at position: " + currentPage);
        }
