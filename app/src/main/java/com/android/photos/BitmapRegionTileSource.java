...
public class BitmapRegionTileSource implements TiledImageRenderer.TileSource {
    ...
    public BitmapRegionTileSource(WallpaperCropActivity context, Uri imageUri, int i, int rotation) {
    }

    public BitmapRegionTileSource(Resources mResources, WallpaperPickerActivity a, int mResId, int i, int rotation) {
    }
