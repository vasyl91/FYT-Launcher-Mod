...
This requires some basic coding skills so that feature probably won't be for everyone (unless it's already adjusted for your car). I'll add instruction how to modify the app asap. 
