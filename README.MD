...
```
Copy and paste that section and rename `android:name="com.syu.carinfo.rzc.biaozhi408.RZC_BZ408IndexActi"` according to your newly modded file from step 7. says.
