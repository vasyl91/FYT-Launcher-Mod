...
- separate canbus functions from Launcher.java, wrap them with try-catch block and create toast informing that modded by user class doesn't work as it should.
